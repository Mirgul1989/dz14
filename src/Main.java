...
public class Main {
    ...
    public static int[] heroesHealth = {260, 250, 270, 250, 250, 250, 250, 400};
    ...
    public static void medicHill() {
        for (int i = 0; i < 1; i++) {
            ...
            if (heroesHealth[i] > 0 && heroesHealth[3] > 0 && heroesHealth[i] < 100) {
                ...
                System.out.println("Medic vylechil " + randomHill);
            }
        ...
        if (heroesHealth[4] > 0 && bossHealth > 0) {
            switch (randomC) {
                case 1:
                    ...
                    System.out.println("Uron critical");
                    System.out.println("Poteri " + randomDamage);
                    break;
                case 2:
                    bossDamage = 50;
                    break;
